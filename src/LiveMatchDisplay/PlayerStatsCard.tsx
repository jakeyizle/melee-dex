...
export const PlayerStatsCard = ({
  ...
  return (
    <Card variant="outlined">
      <CardHeader title="Matchup Stats" />
      <CardContent>
        <Box
          sx={{
            mb: 2,
        ...
        >
          <Typography variant="body1" sx={{ fontWeight: "medium" }}>
            {historicalReplays.length === 1
              ? `${historicalReplays.length} game played`
              : `${historicalReplays.length} games played`}
          </Typography>
        </Box>
