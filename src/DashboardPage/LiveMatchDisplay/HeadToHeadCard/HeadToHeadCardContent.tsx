import { Typography, Box, CardContent, Paper, Grid } from "@mui/material";
import {
    ...
    <CardContent>
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <Box sx={{ mb: 3 }}>
            <Typography variant="subtitle2" sx={{ mb: 1.5 }}>
              {`${getCharacterNameFromId(headToHeadStats[0].currentCharacterId)} vs. ${getCharacterNameFromId(headToHeadStats[1].currentCharacterId)} on ${getStageNameFromId(stageId)}`}
            </Typography>
            <Paper sx={{ p: 2, bgcolor: "rgba(255, 255, 255, 0.05)" }}>
              <Box
                sx={{
