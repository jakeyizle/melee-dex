...
export const getNumberOfRenderers = (numberOfReplays: number, isFastLoad: boolean) => {
    const maxRenderers = isFastLoad ? NUM_CORES * 2 : 1;
    const numRenderers = numberOfReplays < maxRenderers ? numberOfReplays : maxRenderers;
    return numRenderers
}
